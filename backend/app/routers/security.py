...
from app.services.security_converter import SecurityConverter
...
async def convert_security(
    ...
    """
    Perform security and encoding conversions.
    ...
    try:
        ...
        result_path = await SecurityConverter.convert(
